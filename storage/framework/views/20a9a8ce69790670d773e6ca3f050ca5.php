...
<section class="h-100 mt-5">
    <div class="card w-100 bg-transparent text-light text-center border border-light">
        ...
        <div class="card-body text-start">
            <form class="px-5" action="<?php echo e(route('register.action')); ?>" method="POST">
                <?php echo csrf_field(); ?>
                <div class="mb-3">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\XAMPP\htdocs\TaskLaravel\MyTask\resources\views/auth/register.blade.php ENDPATH**/ ?>